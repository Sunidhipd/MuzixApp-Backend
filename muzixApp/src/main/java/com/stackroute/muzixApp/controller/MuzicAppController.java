...
public class MuzicAppController {
    ...
    public ResponseEntity<?> removeTrack(@PathVariable String trackId) throws TrackNotFoundException {
        ResponseEntity responseEntity;
   ...
   //This method is used to get track by id on request
    ...
    public ResponseEntity<?> getTrackById(@PathVariable String trackId) throws TrackNotFoundException {
